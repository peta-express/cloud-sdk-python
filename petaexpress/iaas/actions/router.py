...
class RouterAction(object):
    ...
    def modify_router_static_attributes(self, router_static,
        ...
        @param val1 - val6: please see the doc. https://docs.petaexpress.com/api/router/modify_router_static_attributes.html
    ...
    def modify_router_static_entry_attributes(self,
        ...
        @param val1 - val2: please see the doc. https://docs.petaexpress.com/api/router/modify_router_static_entry_attributes.html
        """
